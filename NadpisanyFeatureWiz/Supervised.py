...
removed_classifiers = [
    ...
    "VotingClassifier",
    "SVC", "BaggingClassifier", "LabelPropagation", "LabelSpreading", 
    "DecisionTreeClassifier", "ExtraTreeClassifier", "ExtraTreesClassifier",
    "Perceptron", "BernoulliNB", "NuSVC", "LogisticRegression",
    "CalibratedClassifierCV", "QuadraticDiscriminantAnalysis", "GaussianNB", "RidgeClassifier", 
    "RidgeClassifierCV", "LinearDiscriminantAnalysis", "NearestCentroid", "SGDClassifier", 
...
#REGRESSORS.append(('CatBoostRegressor', CatBoostRegressor))

# lightgbm.set_config(silent=True)
# catboost.set_option(silent=True)
catclasiffier = catboost.CatBoostClassifier(logging_level='Silent')
CLASSIFIERS.append(("XGBClassifier", xgboost.XGBClassifier))
CLASSIFIERS.append(("LGBMClassifier", lightgbm.LGBMClassifier))
CLASSIFIERS.append(("CatBoostClassifier", catclasiffier))
        ...
        for name, model in tqdm(self.classifiers):
            ...
            try:
                if "random_state" in model().get_params().keys():
                    ...
                    pipe = Pipeline(
                        steps=[("preprocessor", preprocessor), ("classifier", model(verbose=False))]
                    )
